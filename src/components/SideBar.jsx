...
const SideBarMenu = React.memo(() => {
    ...
    return(
        <div className='sideBar-Menu'>
            ...
            <div className='sideBar-Menu-Item'><span>포토카드</span></div>
            <div className='sideBar-Menu-Item'><span>극장안내</span></div>
            <div className='sideBar-Menu-Item'><span>무비포스트</span></div>
            <div className='sideBar-Menu-Item'><span>더 부티크 프라이빗 예매</span></div>
            <div className='sideBar-Menu-Item'><span>제휴/할인 안내</span></div>
            <div 
